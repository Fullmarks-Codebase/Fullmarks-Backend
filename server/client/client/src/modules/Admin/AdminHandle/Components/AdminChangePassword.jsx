...
function AdminChangePassword() {
  ...
  const updatePassword = (e) => {
    ...
    axiosForAdmin
      .put("/users/changePassword", { oldPassword, newPassword: password })
      .then((response) => {
        setAlertMessage({
          variant: "success",
                ...
                <div className='row'>
                  ...
                  <div className='form-group col-12'>
                    <div className='row justify-content-around'>
                      <button
                        type='submit'
                        class='btn btn-primary col-sm-4 col-12'
                      >
                        Update
                      </button>
                      <button
                        type='button'
                        class='btn btn-secondary col-sm-4 col-12'
