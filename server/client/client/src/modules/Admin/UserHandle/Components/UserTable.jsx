...
function UserTable() {
  ...
  const deleteUser = () => {
    axiosForAdmin
      .delete(`customer/${selectedUser.id}`)
      .then((response) => {
                        ...
                        <tr key={index + 1} align='center'>
                          ...
                          <td className='w-25'>
                            <button
                              type='button'
                              onClick={() =>
                                history.push(`/UpdateCustomer/${user.id}`)
                              }
                              className='btn btn-primary mr-lg-2 mb-2 mb-lg-0'
                            >
                              Update
                            </button>
                            <button
              ...
              <div className='row'>
                <div className='form-group col-12'>
                  <label htmlFor='first_name'>
                    Are you sure to remove user "{selectedUser.username}"?{" "}
                  </label>
                </div>
              </div>
              <button
