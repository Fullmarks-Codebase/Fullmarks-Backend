...
function AddQuestion(props) {
  ...
  const {subId , classId, topicId} = props.match.params;
  ...
  const addQuestion = (e) => {
    ...
    var ans_one_image = document.querySelector('#ans_one_image').files[0] || null;
    var ans_two_image = document.querySelector('#ans_two_image').files[0] || null;
    var ans_three_image = document.querySelector('#ans_three_image').files[0] || null;
    var ans_four_image = document.querySelector('#ans_four_image').files[0] || null;
    var question_image = document.querySelector('#question_image').files[0] || null;
    const key = [
      'question',
      'subjectId',
      'setId',
    ...
    axiosForAdmin.post("/questions/add",formData,config).then(res => {
      setAlertMessage({ variant: "success", msg: res.data.message })
      setTimeout(()=>{
        history.replace(`/QuestionsTable/${classId}/${subId}/${topicId}/${id}`)
      },1500)
    }).catch(err => {
          ...
          <div className="col-md-11 col-12">
            <div className="card">
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      <div className="form-group">
                        ...
                        <select className="form-control" required onClick={(e)=>setDiffcult(e.target.value)}>
                  ...
                  <div className="row">
                    <div className="col-md mt-md-0 mt-4">
                      ...
                      <div className="form-group">
                        ...
                        <select className="form-control" onClick={(e)=>setAns_one_status(e.target.value)}>
                    ...
                    <div className="col-md mt-md-0 mt-5">
                      ...
                      <div className="form-group">
                        <label>Is it Correct</label>
                        <select className="form-control" onClick={(e)=>setAns_two_status(e.target.value)}>
                          <option value="false">No</option>
                          <option value="true">Yes</option>
                        </select>
                      </div>
                ...
                <div className="form-group col-md-11 col-11 mt-md-4 mt-0">
                  <div className="row">
                    <div className="col-md mt-md-0 mt-4">
                      ...
                      <div className="form-group">
                        <label>Is it Correct</label>
                        <select className="form-control" onClick={(e)=>setAns_three_status(e.target.value)}>
                          <option value="false">No</option>
                          <option value="true">Yes</option>
                        </select>
                      </div>
                    ...
                    <div className="col-md mt-md-0 mt-5">
                      ...
                      <div className="form-group">
                        <label>Is it Correct</label>
                        <select className="form-control" onClick={(e)=>setAns_Four_status(e.target.value)}>
                          <option value="false">No</option>
                          <option value="true">Yes</option>
                        </select>
                      </div>
              ...
              <div className="form-group row justify-content-center">
                <button type="submit" className="btn btn-primary col-md-2 col-10" disabled={valid} >Create</button>
