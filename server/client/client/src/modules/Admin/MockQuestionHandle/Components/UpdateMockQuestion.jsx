...
function UpdateMockQuestion(props) {
  ...
  const fetchQuestionData = () => {
    axiosForAdmin
      .post("/mockQuestions", { questionId: id })
      .then((res) => {
        console.log(res.data.result);
        setSelectedSubjectId(res.data.result[0].fixSubjectId);
  ...
  const deleteOldImage = (event) => {
    ...
    axiosForAdmin
      .post("/mockQuestions/deleteImage", { id, image_field: name })
      .then((res) => {
        setDeleteButton({ ...deleteButton, [name]: true });
      })
      .catch((err) => {
  ...
  const updateQuestion = (e) => {
    ...
    axiosForAdmin
      .put("/mockQuestions/updateQuestion", formData, config)
      .then((res) => {
              ...
              <div className='card'>
                <form method='POST' onSubmit={(e) => updateQuestion(e)}>
                                  ...
                                  <img
                                    src={
                                      urlCheck(selected.ans_one_image)
                                        ? selected.ans_one_image
                                        : `${process.env.REACT_APP_NODE_URL_ANSWERS}/${selected.ans_one_image}`
                                    }
                                    alt={"selected.question_image"}
                                    width='100%'
                                  />
                                  ...
                                  <img
                                    src={
                                      urlCheck(selected.ans_two_image)
                                        ? selected.ans_two_image
                                        : `${process.env.REACT_APP_NODE_URL_ANSWERS}/${selected.ans_two_image}`
                                    }
                                    alt={"selected.ans_two_image"}
                                    width='100%'
                                  />
                                </div>
                                <div className='col-md col-12'>
                                  ...
                                  <img
                                    src={
                                      urlCheck(selected.ans_three_image)
                                        ? selected.ans_three_image
                                        : `${process.env.REACT_APP_NODE_URL_ANSWERS}/${selected.ans_three_image}`
                                    }
                                    alt={"selected.ans_three_image"}
                                    width='100%'
                                  />
                                </div>
                                <div className='col-md col-12'>
                                  ...
                                  <img
                                    src={
                                      urlCheck(selected.ans_four_image)
                                        ? selected.ans_four_image
                                        : `${process.env.REACT_APP_NODE_URL_ANSWERS}/${selected.ans_four_image}`
                                    }
                                    alt={"selected.question_image"}
                                    width='100%'
                                  />
                  ...
                  <div className='row justify-content-center mt-3 mb-5'>
                    <button
                      type='submit'
                      className='btn btn-primary col-10 col-md-2'
                      disabled={valid}
                    >
                      Update
                    </button>
