...
function SubjectTable(props) {
  ...
  useEffect(() => {
    ...
    axiosForAdmin
      .post("subjects/onlySubjects", { id: id })
      .then((response) => {
  ...
  const deleteSubject = () => {
    axiosForAdmin
      .delete(`subjects/${selectedSub.id}`)
      .then((response) => {
        setRefreshTable(!refreshTable);
      })
      .catch((error) => {
        ...
        <section className='section'>
          ...
          <div className='row'>
            <div className='dropdown col-md-6 col-12'>
              <button
                className='btn btn-primary dropdown-toggle mb-3 custom'
                type='button'
                ...
                {fixSubject.map((subject, index) => {
                  return (
                    <li
                      ...
                      key={index}
                      onClick={(e) => addSubject(e, subject)}
                    >
                      {subject.name}
                    </li>
                  );
                        ...
                        <tr align='center' key={index}>
                          ...
                          <td>
                            <button
                              ...
                              onClick={() =>
                                history.push(
                                  `/Subject/UpdateSubject/${id}/${subject.id}`
                                )
                              }
                            ...
                            <button
                              type='button'
                              onClick={() => {
                                history.push(`/TopicTable/${id}/${subject.id}`);
                              }}
                            ...
                            <button
                              type='button'
                              data-toggle='modal'
                              onClick={() => setSelectedSub(subject)}
            ...
            <div className='modal-body'>
              <div className='row'>
                <div className='form-group col-12'>
                  <label>
                    <h5>
                      Deleting subject will delete its all topics, sets, and
                      questions respestively. Are you sure to remove subject "
                      {selectedSub.name}" ?
                    </h5>{" "}
                  </label>
                </div>
