...
export default function UpdateClass(props){
  ...
  React.useEffect(() => {
      axiosForAdmin.post("/class", { id: id }).then(response => {
  ...
  const updateSubject = (e) => {
      ...
      axiosForAdmin.put("/class/update",formData,config).then(response=>{
  ...
  const deleteOldImage = (event) => {
    ...
    axiosForAdmin.post("/class/deleteImage", { id, class_image: name }).then(res => {
      forceUpdate(n => !n)
    }).catch(err => {
        console.log(err)
    })
              ...
              <div className="row justify-content-center">
                ...
                {selected?<div className="card p-sm-5 p-3">
                  ...
                  <div className="row justify-content-center">
                    ...
                    {
                      alertMessage.msg && (
                        <div className={`alert alert-${alertMessage.variant} col-12`} role="alert">
                          {alertMessage.msg}
                        </div>
                      )
                    }
                  ...
                  <div className="row justify-content-center">                     
                    ...
                    <div className="form-group col-11">
                      ...
                      {selected.class_image ? <>
                        <div className="col-md-8 col-12">
                          {console.log(`${process.env.REACT_APP_NODE_URL_CLASS}/${selected.class_image}`)}
                          <img src={`${process.env.REACT_APP_NODE_URL_CLASS}/${selected.class_image}`} alt={selected.image} width="100%"/>
                        </div>
                        <div className="col-md col-12">
                          <button type="button" className='form-control btn-danger' name="class_image" onClick={(e) => deleteOldImage(e)}>&#x2717;</button>
                        </div>
                      </> : 
                        <>
                          <div className="col-md col-12">    
                    ...
                    <div className="modal-footer">
                      <button type="button" className="btn btn-secondary mr-2" onClick={()=>history.push("/ClassTable")}>Cancel</button>
