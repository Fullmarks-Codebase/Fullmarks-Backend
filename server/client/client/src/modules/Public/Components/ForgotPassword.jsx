...
function ForgotPassword() {
  ...
  const sendEmail = (e) => { 
    e.preventDefault()
    axiosForAdmin.post("/forgotPassword", { email: email }).then((response) => {
              ...
              <div class="card card-primary">
                ...
                {!send?<div class="card-body">
                  ...
                  <p class="text-muted">
                    ...
                    />
                    {
                      <div><sub>{ emailErr?emailErr:null}</sub></div>
                    }
                    </div>
                  ...
                  : <div>
                      <div className={`alert alert-${alertMessage.variant} ml-3 mr-3`} role="alert">
                                {alertMessage.msg}
                      </div>
