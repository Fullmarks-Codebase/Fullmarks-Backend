...
function QuestionsTable(props) {
  ...
  const deleteQuestion = () => {
    axiosForAdmin
      .delete(`/questions/${selectedQuestion.id}`)
      .then((response) => {
        ...
        <section className='section'>
          ...
          <div>
            <button
              ...
              onClick={() =>
                history.push(
                  `/Question/AddQuestion/${classId}/${subId}/${topicId}/${id}`
                )
              }
            >
              Create Question
                      ...
                      questions.map((question, index) => (
                        <tr align='center' key={index + 1}>
                          ...
                          <td className='w-25'>
                            <button
                              type='button'
                              className='btn btn-primary mr-md-2 mb-2'
                              onClick={() =>
                                history.push(
                                  `/Question/UpdateQuestion/${question.classId}/${question.subjectId}/${question.topicId}/${question.setId}/${question.id}`
                                )
                              }
                            >
                              Update
