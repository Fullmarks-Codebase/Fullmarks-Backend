...
export default function UserUpdate(props) {
  ...
  React.useEffect(() => {
    ...
    axiosForAdmin
      .post("/customer/front", { customerId: id })
      .then((response) => {
  ...
  const updateUser = (e) => {
    ...
    axiosForAdmin
      .put("/customer/update", formData, config)
      .then((response) => {
  ...
  const deleteOldImage = (event) => {
    ...
    axiosForAdmin
      .post("/customer/deleteImage", { id: selected.id })
      .then((res) => {
        forceUpdate((n) => !n);
      })
      .catch((err) => {
                      ...
                      <form method='POST' onSubmit={(e) => updateUser(e)}>
                        ...
                        <div className='row'>
                          <div className='form-group col-12 col-sm-6'>
                            ...
                            <input
                              ...
                              name='dob'
                              type='date'
                              defaultValue={moment(selected.dob).format(
                                "YYYY-MM-DD"
                              )}
                              className='form-control'
                              onChange={(e) => onHandleChange(e)}
                              ...
                              <>
                                <div className='row'>
                                  <div className='col-md-8 col-12'>
                                    <img
                                      src={`${process.env.REACT_APP_NODE_URL_USER}/${selected.userProfileImage}`}
                                      alt='profileImage'
                                      width='100%'
                                    />
                                  </div>
                        ...
                        <div className='modal-footer'>
                          <button
                            ...
                            onClick={() => history.push("/UserTable")}
                          >
                            Cancel
                          </button>
                          <button
